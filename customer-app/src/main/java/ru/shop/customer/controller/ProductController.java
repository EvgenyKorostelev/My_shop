...
import ru.shop.customer.controller.payload.NewProductReviewPayload;
import ru.shop.customer.entity.Product;
import ru.shop.customer.service.FavouriteProductsService;
import ru.shop.customer.service.ProductReviewsService;
...
public class ProductController {
    ...
    @GetMapping
    public Mono<String> getProduct(@PathVariable("productId") int id, Model model) {
